...
{
	// 加载BMP文件资源
	HANDLE hBmpBG = ::LoadImage(NULL, _T("resources\\fruit_bg.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
	// 获得当前对话框的视频内容
	CClientDC dc(this);
...
void CGameDlg::InitElement()
{
	...
	// 加载BMP图片资源
	HANDLE hBmpBG = ::LoadImage(NULL, _T("resources\\fruit_element.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
	...
	// 加载BMP图片资源
	HANDLE hMask = ::LoadImage(NULL, _T("resources\\fruit_mask.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
	...
	// 加载游戏暂停BMP图片资源
	HANDLE hCache = ::LoadImage(NULL, _T("resources\\fruit_pause.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
